...
export const PAGE_TEMPLATES: PageTemplate[] = [
  {
    ...
    blocks: [
      ...
      { type: 'menu_grid', config: { layout: 'list', heading: 'Signature Dishes', description: 'Hand-picked favourites curated by our head chef.', selection_mode: 'custom_items', item_ids: [] } },
